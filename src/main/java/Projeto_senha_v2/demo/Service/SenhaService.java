...
public class SenhaService {
    ...
    public synchronized String gerarSenha(String tipo) {
        // Escolhe qual Creator utilizar
        if (tipo.equalsIgnoreCase("normal")) {
            senhaCreator = new SenhaFactory.SenhaNormalCreator();
        } else if (tipo.equalsIgnoreCase("prioritaria")) {
            senhaCreator = new SenhaFactory.SenhaPrioritariaCreator();
        } else {
